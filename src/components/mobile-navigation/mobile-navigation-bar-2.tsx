...
export default function MobileNavigationBar2({ children }: PropsWithChildren) {
  const { state } = useCart();
...
const list = [
  { title: "Home", Icon: Home, href: "/furniture-3" },
  { title: "Propety", Icon: CategoryOutlined, href : "/mobile-categories"},
  { title: "Bookings", Icon: ShoppingBagOutlined, href: "/cart" },
